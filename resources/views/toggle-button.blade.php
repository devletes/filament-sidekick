@auth
    <button
        ...
        title="{{ config('sidekick.assistant.name', 'Assistant') }}"
        aria-label="{{ config('sidekick.assistant.name', 'Assistant') }}"
    >
        {{-- Phosphor "flame", inlined — panels disable blade icon components. --}}
        <svg class="sidekick-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true">
