...
/**
 * The bridge that makes one action class enough: wraps a ProposableAction as
 * the model-facing tool that PROPOSES it. The tool validates via prepare()
 * and stores a confirm card; execution only ever happens from the user's
 * Confirm click in the panel.
 */
