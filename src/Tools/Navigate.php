...
/**
 * Built-in: sends the user's browser to a named in-app destination when the
 * turn completes. Auto-enabled once the host binds an ActionResolver with
 * targets; the panel consumes the stored URL exactly once (ChatPanel).
 */
